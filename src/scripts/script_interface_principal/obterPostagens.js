...
function exibirPostagens(postagens) {
    ...
    postagens.forEach(postagem => {
        ...
        img.src = `http://localhost:3000/api/foto/${postagem.usuario_id._id}`;
...
function comentar(postId, comentario) {
    ...
    fetch(`http://localhost:3000/api/publicacoes/${postId}/comentar`, {
        method: 'POST',
        headers: {
...
function darLike(postId) {
    ...
    fetch(`http://localhost:3000/api/publicacoes/${postId}/like`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function darDeslike(postId) {
    ...
    fetch(`http://localhost:3000/api/publicacoes/${postId}/dislike`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
